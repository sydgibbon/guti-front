            ...
            <form className='w-full divide-y divide-y-reverse'>
                ...
                <div className='form-container h-full w-full p-4 border border-secondary-dark bg-white flex justify-between'>
                    ...
                    <div className='second-form w-1/2 mx-4'>
                        ...
                        <div className='input-management-type my-4'>
                            <p className='text-sm mb-2'>Management Type</p>
                            <div className='flex'>
                                <select className='w-full px-2 rounded-md h-9 border border-secondary-dark bg-medium-gray'>
                        ...
                        <div className='input-brand my-4'>
