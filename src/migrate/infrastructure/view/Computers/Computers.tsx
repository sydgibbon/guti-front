...
const Computers = () => {
  const columns= [
    ...
    },
    {
      name: "TYPES",
      sortable: true,
      selector: (row: Row) => row?.computertypes?.name, // hace referencia al objeto que contiene states dentro (mirar consola chrome)
    },
    {
      name: "OPERATING SYSTEM - NAME",
      sortable: true,
      selector: (row: Row) => row?.computertypes?.name, // codigo de momento hasta que se puedan relacionar sistemas operativos con computers
    },
    {
      name: "LOCATIONS",
      sortable: true,
    ...
    },
    {
      name: "LAST UPDATE",
      sortable: true,
      selector: (row: Row) => row?.date_mod, // hace referencia al objeto que contiene states dentro (mirar consola chrome)
    },
    {
